...
import com.github.AndrzejKieler.domain.repetitionPeriod.repetitionPeriodTypeFactory.AnnualPeriodFactory;
import com.github.AndrzejKieler.domain.repetitionPeriod.repetitionPeriodTypeFactory.MonthlyByNumberPeriodFactory;
import com.github.AndrzejKieler.domain.repetitionPeriod.repetitionPeriodTypeFactory.MonthlyByWeekdayPeriodFactory;
import com.github.AndrzejKieler.domain.repetitionPeriod.repetitionPeriodTypeFactory.WeeklyPeriodFactory;
...
public abstract class RepetitionPeriodFactory {
    ...
    final RepetitionPeriod buildDaily(Date startDate, int repetitionOffset,Date finishDate){
        ...
        var calendar = Calendar.getInstance(TimeZone.getTimeZone("Poland"));

        calendar.setTime(startDate);
        calendar.add(Calendar.YEAR,1);
        Date yearAddedDate = calendar.getTime();
        calendar.setTime(startDate);
        //TODO  4 from dateFacade
